...
<img src="/images/post/forward.png" alt="一个神经元的输出被多个不同分支的神经元作为输入" style="max-width: 70%;" />
...
<img src="/images/post/backward.png" alt="损失对一个神经元中某个参数的梯度的组成成分的可视化描述" style="max-width: 70%;" />
...
### 练习题
1. 卷积层的前向和后向过程分别是怎样的? (参考[卷积神经网络概要](/posts/cnn))
1. 池化层的呢?
1. 各种Normalization层呢?
1. 循环神经网络的呢?
